...
{
  delay(1000);
  Serial.begin(9600);//第五行，再arduino裡加這行
...
void serialEvent(){//第六行負責USB的SERIAL的韓式
  while(Serial.available()){//第七行如果USB有資料
    Serial.read();//第八行就要進來
    myMusic();//順便myMusic波音樂
  }
}
void loop()
{
